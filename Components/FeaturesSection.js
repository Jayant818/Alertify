...
export default function FeaturesSection() {
	return (
		<>
			<div className="container mx-auto px-5 py-10  bg-[#0d0f19]">
				...
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
					...
					<div className="flex flex-col items-center bg-[#151720] shadow-lg p-6 rounded-lg hover:scale-110 transition">
